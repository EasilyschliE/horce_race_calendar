...
def parse_jra_text(text):
    ...
    for i in range(len(chunks)):
        ...
        for m in matches:
            ...
            # レース名の抽出（連続する空白で区切って、最初の要素を名称とする）
            ...
            races.append({
                ...
                "race_num": f"{race_no}R", # ここで「8R」形式に変換
                "race_name": race_name,
                "class": race_class,
                "surface": surface,
...
if __name__ == "__main__":
    ...
    if not df_new.empty:
        # 保存先を月ごとに分ける (例: data/race_data_2026_01.csv)
